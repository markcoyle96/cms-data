...
function themehunk_customizer_widget_init() {
    ...
    'name' => __('Magazine Widget', 'themehunk-customizer'),
    'id' => 'magzine-widget',
    'description' => __('Add Advance Post Widget','themehunk-customizer'),
    'before_widget' => '',
    'after_widget' => '',
    'before_title' => '',
    'after_title' => '',
    ...
    register_sidebar(array(
    'name' => __('Magazine Sidebar Widget', 'themehunk-customizer'),
    'id' => 'magzine-sidebar-widget',
    'description' => __('Add Advance Sidebar Post Widget','themehunk-customizer'),
    'before_widget' => '',
    'after_widget' => '',
    'before_title' => '',
    'after_title' => '',
...
function THunk_Customizer_Comment(){
	comments_popup_link(__('No Comment','themehunk-customizer'), __('1 Comment','themehunk-customizer'), __('% Comments','themehunk-customizer'));
}
/*
