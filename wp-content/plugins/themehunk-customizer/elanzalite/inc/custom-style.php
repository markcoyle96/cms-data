...
$custom_css .= "header,.page header{background:{$hd_bg_color};}
...
a,.post-title h2:hover,a.more-link,.widget .tagcloud a:hover{color:{$theme_color};}
...
.breadcrumbs a:hover,.breadcrumbs .trail-end span{
  color: {$theme_color};
}
