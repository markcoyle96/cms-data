...
class themehunk_customizer_section_one extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array('classname' => 'themehunk-customizer-section-one',
            'description' => 'Show your featured post slider');
...
$ltoption .= '<option value="'.$term_id.'" '.$selected2.'>'.$cat->name.'</option>';
    ...
    border-radius: 1px;
     ...
     <p class="thunk-widget-title">Left Post Slider Settings</p>
    <p>
    ...
    <div class='tchr'></div>
         <p class="thunk-widget-title">Right Side Four Post Settings</p>
     <p><label for="<?php echo $this->get_field_id('lttitle'); ?>"><?php _e('Latest Post Title','elanzalite'); ?></label>
        ...
        <p>
 <p>
    <label for="<?php echo $this->get_field_id('ltcate'); ?>"><?php _e('Choose Category Show Post','themehunk-customizer'); ?></label>
