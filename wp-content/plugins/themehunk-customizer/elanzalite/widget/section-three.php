...
$foption .= '<option value="'.$term_id.'" '.$selected1.'>'.$cat->name.'</option>';
    ...
    <input name="<?php echo $this->get_field_name('title'); ?>" id="<?php echo $this->get_field_id('title'); ?>"  class="widefat" value="<?php echo $title; ?>" >
     ...
     <p><label for="<?php echo $this->get_field_id('ofcount'); ?>"><?php _e('Number of Post Show','elanzalite'); ?></label>
        ...
        <p>
    <p>
    <label for="<?php echo $this->get_field_id('ofcate'); ?>"><?php _e('Choose Category Show Post','themehunk-customizer'); ?></label>
