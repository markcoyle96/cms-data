...
$twooption .= '<option value="'.$term_id.'" '.$selected2.'>'.$cat->name.'</option>';
  ...
  <style>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('one_cate'); ?>"><?php _e('Choose Category Show Post','themehunk-customizer'); ?></label>
        <select name="<?php echo $this->get_field_name('one_cate'); ?>" ><?php echo $oneoption; ?></select>
    </p>
     <p><label for="<?php echo $this->get_field_id('one_count'); ?>"><?php _e('Number of Post Show','elanzalite'); ?></label>
...
<p><label for="<?php echo $this->get_field_id( 'title_bg_color' ); ?>" style="display:block;"><?php _e( 'Title Background Color:','themehunk-customizer' ); ?></label> 
    ...
    <p class="thunk-widget-title">Right Blog Setting</p>
      <p>
    <label for="<?php echo $this->get_field_id('two_cate'); ?>"><?php _e('Choose Category Show Post','themehunk-customizer'); ?></label>
        <select name="<?php echo $this->get_field_name('two_cate'); ?>" ><?php echo $twooption; ?></select>
    </p>
     <p><label for="<?php echo $this->get_field_id('two_count'); ?>"><?php _e('Number of Post Show','elanzalite'); ?></label>
