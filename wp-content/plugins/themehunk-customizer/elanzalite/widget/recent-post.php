...
class THunkcustomizer_RecentPost extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array(
            ...
            'description' => 'ElanzaLite Recent Post'
        );
        parent::__construct('advanced-recent-posts', 'THunk : Recent Post With Images', $widget_ops);
    }
    ...
    function widget($args, $instance) {
        ...
        <div class="recent-post">
           <h4 class="widgettitle"><?php echo apply_filters('widget_title', $instance['title'] ); ?></h4 class="widgettitle">
    ...
    function form($instance) {
        ...
        <?php _e('Excerpt post','elanzalite'); ?>
            </label>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id("excerpt_length"); ?>">
                <?php _e('Excerpt post length','elanzalite'); ?>
            </label>
        ...
        <p><label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Number of Post Show','elanzalite'); ?></label>
