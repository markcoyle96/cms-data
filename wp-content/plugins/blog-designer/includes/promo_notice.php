        ...
        echo '
            ...
            <style>/* Promotional notice css*/
                ...
                <div class="notice notice-success" id="blog_designer_promo" style="min-height:120px">
                        ...
                        <p style="font-size:16px">' . __("We are glad you like <strong>Blog Designer</strong> and have been using it since the past few days. It is time to take the next step.", "blog-designer") . '</p>
                        <p>
                                ...
                                <a class="bd_button bd_button4" target="_blank" href="https://twitter.com/home?status=' . rawurlencode('I use #blogdesigner to design my #WordPress blog site - http://blogdesigner.solwininfotech.com') . '">' . __("Tweet about Blog Designer", "blog-designer") . '</a>
                        </p>
                </div>';
    }
